console.log("hi")
const CallFirst = () => {
    let plainText = document.getElementById("I1").value;
    let key = document.getElementById("I2").value;
...
const CallSecond = () => {
    let plainText = document.getElementById("I3").value;
    let key = document.getElementById("I4").value;
...
const CallThird = () => {
    let plainText = document.getElementById("I5").value;
    let key = document.getElementById("I6").value;
    console.log("manual key formater");
...
const CallForth = () => {
    let plainText = document.getElementById("I7").value;
    let key = document.getElementById("I8").value;
    //manual key formater
    console.log("manual key formater");
...
const CallFifth = () => {
    let plainText = document.getElementById("I9").value;
    let key = document.getElementById("I10").value;
